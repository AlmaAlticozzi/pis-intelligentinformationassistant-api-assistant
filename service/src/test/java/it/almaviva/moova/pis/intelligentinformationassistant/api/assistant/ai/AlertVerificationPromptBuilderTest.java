...
class AlertVerificationPromptBuilderTest {
    ...
    void eventSystemCompactV2PreservesManualRegressionRules() {
        ...
        assertThat(template)
                ...
                .contains("timetabledDeparturePlatform.dsc PLATFORM_NOT_EQUALS_FIELD actualDeparturePlatform.platform.dsc")
                .contains("timetabledArrivalPlatform.dsc PLATFORM_NOT_EQUALS_FIELD actualArrivalPlatform.platform.dsc")
                .contains("Do not use platform technical id fields with PLATFORM_EQUALS_FIELD or PLATFORM_NOT_EQUALS_FIELD")
