...
@Entity
@Table(name = "assistant_question_status", schema = "pis_intelligentinformationassistant")
public class AssistantQuestionStatus {
    @Id
    @Size(max = 40)
    @Column(name = "sgl_status", nullable = false, length = 40)
