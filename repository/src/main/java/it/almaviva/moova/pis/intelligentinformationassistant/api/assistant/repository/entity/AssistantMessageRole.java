...
@Entity
@Table(name = "assistant_message_role", schema = "pis_intelligentinformationassistant")
public class AssistantMessageRole {
    @Id
    @Size(max = 30)
    @Column(name = "sgl_role", nullable = false, length = 30)
    private String sglRole;

    @Size(max = 255)
    @NotNull
    @Column(name = "dsc_role", nullable = false)
