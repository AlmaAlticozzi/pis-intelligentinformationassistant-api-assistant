...
@Entity
@Table(name = "agent_complexity", schema = "pis_intelligentinformationassistant")
public class AgentComplexity {
    @Id
    @Size(max = 30)
    @Column(name = "sgl_complexity", nullable = false, length = 30)
    private String sglComplexity;

    @Size(max = 255)
    @NotNull
    @Column(name = "dsc_complexity", nullable = false)
    private String dscComplexity;
