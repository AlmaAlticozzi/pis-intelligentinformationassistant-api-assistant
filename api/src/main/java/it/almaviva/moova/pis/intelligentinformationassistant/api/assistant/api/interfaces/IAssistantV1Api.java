...
import it.almaviva.moova.pis.intelligentinformationassistant.api.assistant.model.assistant.AgentDefinitionPatchRequest;
...
import it.almaviva.moova.pis.intelligentinformationassistant.api.assistant.model.assistant.AgentMetricSnapshotListResponse;
import it.almaviva.moova.pis.intelligentinformationassistant.api.assistant.model.assistant.AgentOutputDetail;
import it.almaviva.moova.pis.intelligentinformationassistant.api.assistant.model.assistant.AgentOutputListResponse;
...
import it.almaviva.moova.pis.intelligentinformationassistant.api.assistant.model.assistant.AgentRunDetail;
import it.almaviva.moova.pis.intelligentinformationassistant.api.assistant.model.assistant.AgentRunKillRequest;
import it.almaviva.moova.pis.intelligentinformationassistant.api.assistant.model.assistant.AgentRunListResponse;
import it.almaviva.moova.pis.intelligentinformationassistant.api.assistant.model.assistant.AgentRunLogListResponse;
import it.almaviva.moova.pis.intelligentinformationassistant.api.assistant.model.assistant.AgentRunRestartRequest;
import it.almaviva.moova.pis.intelligentinformationassistant.api.assistant.model.assistant.AgentRunStatus;
import it.almaviva.moova.pis.intelligentinformationassistant.api.assistant.model.assistant.AgentRuntimeEventListResponse;
...
import it.almaviva.moova.pis.intelligentinformationassistant.api.assistant.model.assistant.AlertDisableRequest;
import it.almaviva.moova.pis.intelligentinformationassistant.api.assistant.model.assistant.AlertEnableRequest;
import it.almaviva.moova.pis.intelligentinformationassistant.api.assistant.model.assistant.AlertInterpreterType;
import it.almaviva.moova.pis.intelligentinformationassistant.api.assistant.model.assistant.AlertPatchRequest;
...
import it.almaviva.moova.pis.intelligentinformationassistant.api.assistant.model.assistant.AssistantSession;
import it.almaviva.moova.pis.intelligentinformationassistant.api.assistant.model.assistant.AssistantSessionCreateRequest;
...
import it.almaviva.moova.pis.intelligentinformationassistant.api.assistant.model.assistant.SuggestionDetail;
import it.almaviva.moova.pis.intelligentinformationassistant.api.assistant.model.assistant.SuggestionHeader;
...
import it.almaviva.moova.pis.intelligentinformationassistant.api.assistant.model.assistant.SuggestionTextPatchRequest;
import it.almaviva.moova.pis.intelligentinformationassistant.api.assistant.model.assistant.ToolExecutionListResponse;
...
public interface IAssistantV1Api {
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Disable an alert", notes = "Disables runtime execution for an alert without deleting its configuration or historical suggestions.  ## Additional notes  - This operation disables runtime execution for an alert without deleting its configuration.  - Disabling an alert stops future suggestion generation but does not modify existing suggestions.  - Disabled alerts remain available for reading, editing, verification and future re-enabling when allowed.  - `operatorNote` can be used to store the reason for disabling the alert.  - Disabling an already disabled alert should be treated as a conflict unless the implementation explicitly supports idempotent disable semantics.  ## Errors  Invalid parameters should raise an HTTP Status Code 400 according with the following list:  - `HTTP Status Code 400`, when the `alertId` path parameter is empty or contains only whitespace characters. Error code: `IIA-ALT-DIS-400-001`  - `HTTP Status Code 400`, when the `alertId` path parameter exceeds 50 characters. Error code: `IIA-ALT-DIS-400-002`  - `HTTP Status Code 400`, when the request body is provided but is not a valid JSON serialization of schema `AlertDisableRequest`. Error code: `IIA-ALT-DIS-400-003`  - `HTTP Status Code 400`, when the `operatorNote` field exceeds 1000 characters. Error code: `IIA-ALT-DIS-400-004`  - `HTTP Status Code 404`, when no alert with the given `alertId` is found. Error code: `IIA-ALT-DIS-404-001`  - `HTTP Status Code 409`, when the alert is deleted and cannot be disabled. Error code: `IIA-ALT-DIS-409-001`  - `HTTP Status Code 409`, when the alert is already disabled. Error code: `IIA-ALT-DIS-409-002`  - `HTTP Status Code 409`, when the alert is currently verifying or deploying and cannot be disabled safely. Error code: `IIA-ALT-DIS-409-003`  - `HTTP Status Code 500`, when an unexpected error occurs while disabling the alert. Error code: `IIA-ALT-DIS-500-001` ", authorizations = {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 409, message = "Conflict or invalid workflow transition.", response = Error.class),
        @ApiResponse(code = 500, message = "Unexpected error.", response = Error.class) })
    AlertDetail disableAlert(@PathParam("alertId") @Size(max=50) @ApiParam("Alert identifier.") String alertId,@Valid AlertDisableRequest alertDisableRequest);


    /**
     * Enables runtime execution for a verified alert.  Allowed source status: `VERIFIED` or `DISABLED`. Alerts with status `VERIFYING`, `REJECTED`, `ERROR` or `DELETED` cannot be enabled.   ## Additional notes  - This operation enables runtime execution for a verified alert.  - Allowed source statuses are `VERIFIED` and `DISABLED`.  - Alerts with status `VERIFYING`, `REJECTED`, `ERROR` or `DELETED` cannot be enabled.  - Enabling an alert allows future suggestion generation according to the interpreter logic and optional schedule.  - Enabling an alert must not regenerate historical suggestions.  - `operatorNote` can be used to store the reason for enabling the alert.  ## Errors  Invalid parameters should raise an HTTP Status Code 400 according with the following list:  - `HTTP Status Code 400`, when the `alertId` path parameter is empty or contains only whitespace characters. Error code: `IIA-ALT-ENA-400-001`  - `HTTP Status Code 400`, when the `alertId` path parameter exceeds 50 characters. Error code: `IIA-ALT-ENA-400-002`  - `HTTP Status Code 400`, when the request body is provided but is not a valid JSON serialization of schema `AlertEnableRequest`. Error code: `IIA-ALT-ENA-400-003`  - `HTTP Status Code 404`, when no alert with the given `alertId` is found. Error code: `IIA-ALT-ENA-404-001`  - `HTTP Status Code 409`, when the alert status is not `VERIFIED` or `DISABLED`. Error code: `IIA-ALT-ENA-409-001`  - `HTTP Status Code 409`, when the alert has no valid verified interpreter. Error code: `IIA-ALT-ENA-409-002`  - `HTTP Status Code 409`, when the alert is already enabled. Error code: `IIA-ALT-ENA-409-003`  - `HTTP Status Code 500`, when an unexpected error occurs while enabling the alert. Error code: `IIA-ALT-ENA-500-001` 
     *
     * @param alertId Alert identifier.
     * @param alertEnableRequest 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Enable a verified alert", notes = "Enables runtime execution for a verified alert.  Allowed source status: `VERIFIED` or `DISABLED`. Alerts with status `VERIFYING`, `REJECTED`, `ERROR` or `DELETED` cannot be enabled.   ## Additional notes  - This operation enables runtime execution for a verified alert.  - Allowed source statuses are `VERIFIED` and `DISABLED`.  - Alerts with status `VERIFYING`, `REJECTED`, `ERROR` or `DELETED` cannot be enabled.  - Enabling an alert allows future suggestion generation according to the interpreter logic and optional schedule.  - Enabling an alert must not regenerate historical suggestions.  - `operatorNote` can be used to store the reason for enabling the alert.  ## Errors  Invalid parameters should raise an HTTP Status Code 400 according with the following list:  - `HTTP Status Code 400`, when the `alertId` path parameter is empty or contains only whitespace characters. Error code: `IIA-ALT-ENA-400-001`  - `HTTP Status Code 400`, when the `alertId` path parameter exceeds 50 characters. Error code: `IIA-ALT-ENA-400-002`  - `HTTP Status Code 400`, when the request body is provided but is not a valid JSON serialization of schema `AlertEnableRequest`. Error code: `IIA-ALT-ENA-400-003`  - `HTTP Status Code 404`, when no alert with the given `alertId` is found. Error code: `IIA-ALT-ENA-404-001`  - `HTTP Status Code 409`, when the alert status is not `VERIFIED` or `DISABLED`. Error code: `IIA-ALT-ENA-409-001`  - `HTTP Status Code 409`, when the alert has no valid verified interpreter. Error code: `IIA-ALT-ENA-409-002`  - `HTTP Status Code 409`, when the alert is already enabled. Error code: `IIA-ALT-ENA-409-003`  - `HTTP Status Code 500`, when an unexpected error occurs while enabling the alert. Error code: `IIA-ALT-ENA-500-001` ", authorizations = {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 409, message = "Conflict or invalid workflow transition.", response = Error.class),
        @ApiResponse(code = 500, message = "Unexpected error.", response = Error.class) })
    AlertDetail enableAlert(@PathParam("alertId") @Size(max=50) @ApiParam("Alert identifier.") String alertId,@Valid AlertEnableRequest alertEnableRequest);
    ...
    /**
     * Updates mutable fields of an alert definition.  If the prompt changes, the backend must reset the alert to `VERIFYING` or require a new explicit verification depending on implementation strategy. A verified interpreter must never remain active after its source prompt has changed without re-verification.  ## Additional notes  - This operation updates mutable fields of an alert definition.  - Omitted fields must keep their current persisted value unchanged.  - Changing the `prompt` requires re-verification before the alert can safely run again.  - A verified interpreter must never remain active after its source prompt has changed without re-verification.  - When the prompt changes, the implementation must either reset the alert to `VERIFYING` or require an explicit call to `POST /v1/alerts/{alertId}/verify`.  - Updating an enabled alert can temporarily disable runtime execution if re-verification is required.  - `schedule` is meaningful only for scheduled interpreters.  ## Errors  Invalid parameters should raise an HTTP Status Code 400 according with the following list:  - `HTTP Status Code 400`, when the `alertId` path parameter is empty or contains only whitespace characters. Error code: `IIA-ALT-UPD-400-001`  - `HTTP Status Code 400`, when the `alertId` path parameter exceeds 50 characters. Error code: `IIA-ALT-UPD-400-002`  - `HTTP Status Code 400`, when the request body is missing. Error code: `IIA-ALT-UPD-400-003`  - `HTTP Status Code 400`, when the request body is not a valid JSON serialization of schema `AlertPatchRequest`. Error code: `IIA-ALT-UPD-400-004`  - `HTTP Status Code 400`, when none of `name`, `description`, `prompt` or `schedule` is provided. Error code: `IIA-ALT-UPD-400-005`  - `HTTP Status Code 400`, when the `name` field is provided but is empty or contains only whitespace characters. Error code: `IIA-ALT-UPD-400-006`  - `HTTP Status Code 400`, when the `name` field exceeds 120 characters. Error code: `IIA-ALT-UPD-400-007`  - `HTTP Status Code 400`, when the `description` field exceeds 1000 characters. Error code: `IIA-ALT-UPD-400-008`  - `HTTP Status Code 400`, when the `prompt` field is provided but contains fewer than 10 characters or exceeds 8000 characters. Error code: `IIA-ALT-UPD-400-009`  - `HTTP Status Code 400`, when `schedule.frequencySeconds` is lower than `30` or greater than `86400`. Error code: `IIA-ALT-UPD-400-010`  - `HTTP Status Code 400`, when `schedule.timeWindowMinutes` is lower than `1` or greater than `1440`. Error code: `IIA-ALT-UPD-400-011`  - `HTTP Status Code 400`, when `schedule.cronExpression` is provided but is not supported or is not valid. Error code: `IIA-ALT-UPD-400-012`  - `HTTP Status Code 404`, when no alert with the given `alertId` is found. Error code: `IIA-ALT-UPD-404-001`  - `HTTP Status Code 409`, when the alert is deleted and cannot be updated. Error code: `IIA-ALT-UPD-409-001`  - `HTTP Status Code 409`, when an active alert with the same normalized name already exists. Error code: `IIA-ALT-UPD-409-002`  - `HTTP Status Code 409`, when the alert is currently verifying or deploying and cannot be updated. Error code: `IIA-ALT-UPD-409-003`  - `HTTP Status Code 500`, when an unexpected error occurs while updating the alert definition. Error code: `IIA-ALT-UPD-500-001` 
     *
     * @param alertId Alert identifier.
     * @param alertPatchRequest 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Update alert definition", notes = "Updates mutable fields of an alert definition.  If the prompt changes, the backend must reset the alert to `VERIFYING` or require a new explicit verification depending on implementation strategy. A verified interpreter must never remain active after its source prompt has changed without re-verification.  ## Additional notes  - This operation updates mutable fields of an alert definition.  - Omitted fields must keep their current persisted value unchanged.  - Changing the `prompt` requires re-verification before the alert can safely run again.  - A verified interpreter must never remain active after its source prompt has changed without re-verification.  - When the prompt changes, the implementation must either reset the alert to `VERIFYING` or require an explicit call to `POST /v1/alerts/{alertId}/verify`.  - Updating an enabled alert can temporarily disable runtime execution if re-verification is required.  - `schedule` is meaningful only for scheduled interpreters.  ## Errors  Invalid parameters should raise an HTTP Status Code 400 according with the following list:  - `HTTP Status Code 400`, when the `alertId` path parameter is empty or contains only whitespace characters. Error code: `IIA-ALT-UPD-400-001`  - `HTTP Status Code 400`, when the `alertId` path parameter exceeds 50 characters. Error code: `IIA-ALT-UPD-400-002`  - `HTTP Status Code 400`, when the request body is missing. Error code: `IIA-ALT-UPD-400-003`  - `HTTP Status Code 400`, when the request body is not a valid JSON serialization of schema `AlertPatchRequest`. Error code: `IIA-ALT-UPD-400-004`  - `HTTP Status Code 400`, when none of `name`, `description`, `prompt` or `schedule` is provided. Error code: `IIA-ALT-UPD-400-005`  - `HTTP Status Code 400`, when the `name` field is provided but is empty or contains only whitespace characters. Error code: `IIA-ALT-UPD-400-006`  - `HTTP Status Code 400`, when the `name` field exceeds 120 characters. Error code: `IIA-ALT-UPD-400-007`  - `HTTP Status Code 400`, when the `description` field exceeds 1000 characters. Error code: `IIA-ALT-UPD-400-008`  - `HTTP Status Code 400`, when the `prompt` field is provided but contains fewer than 10 characters or exceeds 8000 characters. Error code: `IIA-ALT-UPD-400-009`  - `HTTP Status Code 400`, when `schedule.frequencySeconds` is lower than `30` or greater than `86400`. Error code: `IIA-ALT-UPD-400-010`  - `HTTP Status Code 400`, when `schedule.timeWindowMinutes` is lower than `1` or greater than `1440`. Error code: `IIA-ALT-UPD-400-011`  - `HTTP Status Code 400`, when `schedule.cronExpression` is provided but is not supported or is not valid. Error code: `IIA-ALT-UPD-400-012`  - `HTTP Status Code 404`, when no alert with the given `alertId` is found. Error code: `IIA-ALT-UPD-404-001`  - `HTTP Status Code 409`, when the alert is deleted and cannot be updated. Error code: `IIA-ALT-UPD-409-001`  - `HTTP Status Code 409`, when an active alert with the same normalized name already exists. Error code: `IIA-ALT-UPD-409-002`  - `HTTP Status Code 409`, when the alert is currently verifying or deploying and cannot be updated. Error code: `IIA-ALT-UPD-409-003`  - `HTTP Status Code 500`, when an unexpected error occurs while updating the alert definition. Error code: `IIA-ALT-UPD-500-001` ", authorizations = {
        
        @Authorization(value = "bearerAuth")
         }, tags={ "Alerts" })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Alert updated successfully.", response = AlertDetail.class),
        @ApiResponse(code = 400, message = "Invalid request or invalid parameter.", response = Error.class),
        @ApiResponse(code = 401, message = "Missing or invalid authentication.", response = Error.class),
        @ApiResponse(code = 403, message = "Authenticated user is not allowed to perform the operation.", response = Error.class),
        @ApiResponse(code = 404, message = "Requested resource was not found.", response = Error.class),
        @ApiResponse(code = 409, message = "Conflict or invalid workflow transition.", response = Error.class),
        @ApiResponse(code = 500, message = "Unexpected error.", response = Error.class) })
    AlertDetail patchAlert(@PathParam("alertId") @Size(max=50) @ApiParam("Alert identifier.") String alertId,@Valid @NotNull AlertPatchRequest alertPatchRequest);
